...
#pragma HLS ARRAY_PARTITION variable=xbuf block factor = 8 dim=1
#pragma HLS ARRAY_PARTITION variable=layer_1_out factor = 10 dim=1
#pragma HLS ARRAY_PARTITION variable=layer_2_out block factor = 10 dim=1
